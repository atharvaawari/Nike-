  ...
  return (
    ...
    >
      <div className="relative xl:w-2/5 flex flex-col justify-center items-start w-full max-xl:padding-x pt-28">
        <p className="text-xl font-montserrat text-coral-red dark:font-semibold" >Our Summer Collections</p>
        <h1 className="mt-10 font-palanquin text-8xl max-sm:text[72px] max-sm:leading[82] font-bold dark:text-white">
          <span className="xl:bg-white xl:whitespace-nowrap relative z-10 pr-10 dark:bg-gray-900">The New Arrival</span>
          <br />
      ...
      <div className="relative flex-1 flex justify-center items-center xl:min-h-screen max-xl:py-40 bg-primary bg-hero bg-cover bg-center">
        <img
          ...
          width={610}
          height={500}
          className="object-contain relative z-10 dark:mix-blend-darken" />
